...
static TerrainTypeClass const Mine(TERRAIN_MINE,
                                   ...
                                   (short const*)_List10,
                                   NULL);
static TerrainTypeClass const Boxes01(TERRAIN_BOXES01,
                                      THEATERF_INTERIOR,
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes02(TERRAIN_BOXES02,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes03(TERRAIN_BOXES03,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes04(TERRAIN_BOXES04,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes05(TERRAIN_BOXES05,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes06(TERRAIN_BOXES06,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes07(TERRAIN_BOXES07,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes08(TERRAIN_BOXES08,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
                                      ...
                                      (short const*)_List10,
                                      NULL);
static TerrainTypeClass const Boxes09(TERRAIN_BOXES09,
                                      THEATERF_INTERIOR,
                                      XYP_COORD(12, 24), // Center base coordinate offset.
                                      true,              // Is it immune to normal combat damage?
                                      false,             // Is based on the water?
...
static TerrainTypeClass const Ice01(TERRAIN_ICE01,
                                    THEATERF_SNOW,
                                    ...
                                    NULL);
static TerrainTypeClass const Ice02(TERRAIN_ICE02,
                                    THEATERF_SNOW,
                                    XYP_COORD(12, 24), // Center base coordinate offset.
                                    true,              // Is it immune to normal combat damage?
                                    true,              // Is based on the water?
                                    ...
                                    NULL);
static TerrainTypeClass const Ice03(TERRAIN_ICE03,
                                    THEATERF_SNOW,
                                    ...
                                    (short const*)_List11,
                                    NULL);
static TerrainTypeClass const Ice04(TERRAIN_ICE04,
                                    THEATERF_SNOW,
                                    XYP_COORD(12, 12), // Center base coordinate offset.
                                    true,              // Is it immune to normal combat damage?
                                    true,              // Is based on the water?
                                    ...
                                    (short const*)_List10,
                                    NULL);
static TerrainTypeClass const Ice05(TERRAIN_ICE05,
                                    THEATERF_SNOW,
                                    XYP_COORD(12, 12), // Center base coordinate offset.
                                    true,              // Is it immune to normal combat damage?
                                    true,              // Is based on the water?
 ...
 *=============================================================================================*/
TerrainTypeClass::TerrainTypeClass(TerrainType terrain,
                                   int theater,
