...
public:
    ...
    bool Is_Loaded() const { return SectionList.First()->Is_Valid(); }
    ...
    const List<FastINISection> &Section_List() const { return SectionList; }
    IndexClass<FastINISection *> &Section_Index() { return SectionIndex; }
    ...
    int Section_Count() { return SectionIndex.Count(); }
