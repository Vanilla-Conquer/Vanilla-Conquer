...
#ifdef _WIN32
    std::wstring homedir = UTF8To16(PathsClass::Instance().User_Path());
    homedir += L"crashlogs";
    std::wstring handler_path = L"vccrashhandler.exe";
#else
    std::string homedir = PathsClass::Instance().User_Path();
    homedir += "crashlogs";
    std::string handler_path = "vccrashhandler";
#endif
